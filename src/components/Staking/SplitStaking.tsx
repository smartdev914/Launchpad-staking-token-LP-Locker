...
const SplitStakingComponent: React.FC = () => {
  ...
  const copyClipboard = (event: MouseEvent, data:string) => {
                  ...
                  <div className="flex flex-col justify-center items-center gap-1 font-extralight w-full">
                    ...
                    <div className="text-xl">
                      ...
                      >
                        ...
                        <FontAwesomeIcon icon={faExternalLinkAlt} size="sm" className="opacity-70" />
                        <FontAwesomeIcon icon={faCopy} size="sm" className="opacity-70 ml-2" onClick={({nativeEvent}) => copyClipboard(nativeEvent, contract.address)} />
                      </a>
                    </div>
                  </div>
