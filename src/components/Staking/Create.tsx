...
const Create: React.FC = () => {
  ...
  const onInputLockDays = useCallback(
    (e: FormEvent<HTMLInputElement>) => {
      ...
      try {
        setLockDays(parseInt(e.currentTarget.value))
      } catch (err) {
        console.error(err)
      }
    },
  ...
  }, [mounted, tokenData, chainId, createStaking, navigate, pushNotification, stakingType, rewardsTokenData, lockDays])
                        ...
                        {rewardsTokenData && (
                          <>
                            <div className="flex justify-between items-start gap-4">
                              <span className='min-w-[110px]'>Rewards rate:</span>
                            ...
                            <div className="flex justify-between items-center gap-4">
                              <span className='min-w-[110px]'>Lock Days:</span>
                              <Input
                                className="w-full"
                                placeholder="days"
                                defaultValue={0}
                                onInput={onInputLockDays}
                              />
                            </div>
                          </>
                        )}
