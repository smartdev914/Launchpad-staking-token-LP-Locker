...
const LockDetail: React.FC<LockProps> = ({ lockId }) => {
  ...
  const [manageExpanded, setManageExpanded] = useState<boolean>(true)
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex flex-col overflow-hidden mr-4">
                      <Title className="flex-col">
                        <div className="self-start flex max-w-full gap-1">
                          <BackButton/>
                          <div
                    ...
                    <section className="text-gray-100 grid grid-cols-1 sm:grid-cols-2 w-full gap-2">
                      ...
                      <PrimaryButton
                        ...
                        disabled={
                          isWithdrawing ||
                          lockData.balance.eq(0) ||
                          BigNumber.from(lockData.unlockTime).gt(BigNumber.from(lockData.blockTime))
                        }
                        onClick={() => {
                          //
