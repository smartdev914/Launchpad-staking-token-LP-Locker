...
const Header: React.FC<Props> = ({ filterEnabled = true, onFilterInput }) => {
  ...
  return (
    <TopSection>
      <SectionInner>
        <Title>
          <Link to="/lp-locker" className='font-bold'>Liquidity Token Locker V1</Link>
        ...
        <div className="my-2 grid grid-cols-1 md:grid-cols-2 items-center gap-3">
          <div className="grid grid-cols-1 md:grid-cols-2 w-full md:flex justify-end gap-3">
            <Link to="/lp-locker/create">
            ...
            {account ? (
              <Link to={`/lp-locker/search/${account}`}>
