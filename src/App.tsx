...
import NftLaunch from './components/NftLaunch'
...
import ManageLpLockers from './components/LpLocker/Account'
import CreateLpLocker from './components/LpLocker/Create'

import Staking from './components/Staking'

import Roulette from './components/Roulette'
import StealthNft from './components/StealthNft'
...
import StealthStake from './components/StealthStake'
import Stealthpay from './components/Stealthpay/Stealthpay'
import Send from './components/Stealthpay/Send_form'
import Receive from './components/Stealthpay/receive'
import Setup from './components/Stealthpay/setup'
      ...
      <Outer>
        ...
        <RightArea>
          ...
          <Routes>
            ...
            <Route path="/launches/" element={<Launch viewMode="all" />} />
            <Route path="/launches/create" element={<Launch viewMode="create" />} />
            <Route path="/launches/:chainId/:address" element={<Launch viewMode="detail" />} />
            <Route path="/launches/admin/:chainId/:address" element={<Launch viewMode="admin" />} />

            <Route path="/nfts/" element={<NftLaunch viewMode="all" />} />
            <Route path="/nfts/create" element={<NftLaunch viewMode="create" />} />
            <Route path="/nfts/:chainId/:address" element={<NftLaunch viewMode="detail" />} />
            <Route path="/nfts/admin/:chainId/:address" element={<NftLaunch viewMode="admin" />} />

            <Route path="/tokens/" element={<Tokens viewMode="all" />} />
            <Route path="/tokens/create" element={<Tokens viewMode="create" />} />
            <Route path="/tokens/:chainId/:address" element={<Tokens viewMode="all" />} />
            ...
            <Route
              path="/lp-locker/search/:account"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<ManageLpLockers />} />
                </TokenLockerManagerV1ContractContextProvider>
              }
            />
            <Route
              path="/lp-locker/account/:account"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<ManageLpLockers />} />
                </TokenLockerManagerV1ContractContextProvider>
            ...
            />
            <Route
              path="/lp-locker/create"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<CreateLpLocker />} />
                </TokenLockerManagerV1ContractContextProvider>
              }
            />
            <Route
              path="/lp-locker/create/:address"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<CreateLpLocker />} />
                </TokenLockerManagerV1ContractContextProvider>
            ...
            />
            <Route
              path="/lp-locker/watchlist"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<LpLocker useWatchlist={true} />} />{' '}
                </TokenLockerManagerV1ContractContextProvider>
              }
            />
            <Route
              path="/lp-locker/:chainId/:address"
              element={
                <TokenLockerManagerV1ContractContextProvider>
                  <LockWatchlistProvider children={<LpLocker />} />
                </TokenLockerManagerV1ContractContextProvider>
              }
            />
            <Route
            ...
            <Route path="/bot-yard" element={<BotYard />} />
            <Route path="/roulette" element={<Roulette />} />
            <Route path="/stealthnft" element={<StealthNft />} />
            <Route path="/stealthpay" element={<Stealthpay />} />
            <Route path="/stealthpay/send" element={<Send />} />
            <Route path="/stealthstake" element={<StealthStake />} />
            <Route path="/stealthstake/:wallet" element={<StealthStake />} />
            <Route path="/stealthpay/receive" element={<Receive />} />
            <Route path="/stealthpay/setup" element={<Setup />} />
...
const AppWeb3: React.FC = () => {
  ...
  useEffect(() => {
    if (!connecting && !connector /* && window.localStorage.getItem('STEALTHPAD_AUTO_CONNECT') !== '1' */) {
      setConnecting(true)
